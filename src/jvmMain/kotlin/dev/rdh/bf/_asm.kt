...
inline val MethodVisitor.dup_x1; get() = visitInsn(DUP_X1)
inline val MethodVisitor.dup_x2; get() = visitInsn(DUP_X2)
inline val MethodVisitor.dup2_x1; get() = visitInsn(DUP2_X1)
inline val MethodVisitor.dup2_x2; get() = visitInsn(DUP2_X2)
...
inline fun MethodVisitor.load(local: LocalVar) = load(local.type, local.index)
...
inline fun MethodVisitor.store(local: LocalVar) = store(local.type, local.index)
